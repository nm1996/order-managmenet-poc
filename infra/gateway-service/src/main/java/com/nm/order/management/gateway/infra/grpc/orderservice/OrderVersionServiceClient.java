package com.nm.order.management.gateway.infra.grpc.orderservice;
...
@Slf4j
@Service
public class OrderVersionServiceClient extends AbstractServiceClient<VersionServiceGrpc.VersionServiceBlockingStub> {
    private static final String SERVICE_NAME = "ORDER-SERVICE";

    @Autowired
    public OrderVersionServiceClient(ServiceCloudOrchestratorImpl serviceCloudOrchestrator) {
