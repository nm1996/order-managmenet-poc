package com.nm.order.management.productservice.server;
...
public class VersionServerImpl extends VersionServiceGrpc.VersionServiceImplBase {
    ...
    public void getVersion(VersionRequest request, io.grpc.stub.StreamObserver<VersionResponse> responseObserver) {
        log.info("Sending service version [service={}]", "product-service");
        try {
            ...
            log.error("Error while sending service version [service = {}, msg ={}]", "product-service", e.getMessage());
