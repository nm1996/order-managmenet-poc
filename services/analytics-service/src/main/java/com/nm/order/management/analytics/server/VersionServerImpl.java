package com.nm.order.management.analytics.server;
...
public class VersionServerImpl extends VersionServiceGrpc.VersionServiceImplBase {
    ...
    public void getVersion(VersionRequest request, io.grpc.stub.StreamObserver<VersionResponse> responseObserver) {
        log.info("Sending service version [service={}]", "analytics-service");
        try {
            ...
            log.error("Error while sending service version [service = {}, msg ={}]", "analytics-service", e.getMessage());
